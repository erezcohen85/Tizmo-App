...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "data-[selected-single=true]:bg-lamp/[.13] data-[selected-single=true]:text-lamp data-[range-middle=true]:bg-lamp/[.13] data-[range-middle=true]:text-lamp data-[range-start=true]:bg-lamp/[.13] data-[range-start=true]:text-lamp data-[range-end=true]:bg-lamp/[.13] data-[range-end=true]:text-lamp group-data-[focused=true]/day:border-ring group-data-[focused=true]/day:ring-ring/50 flex aspect-square h-auto w-full min-w-[--cell-size] flex-col gap-1 font-normal leading-none data-[range-end=true]:rounded-md data-[range-middle=true]:rounded-none data-[range-start=true]:rounded-md group-data-[focused=true]/day:relative group-data-[focused=true]/day:z-10 group-data-[focused=true]/day:ring-[3px] [&>span]:text-xs [&>span]:opacity-70",
        defaultClassNames.day,
        className
      )}
      {...props}
